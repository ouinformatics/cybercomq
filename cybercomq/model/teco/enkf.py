...
def runEnKF(task_id=None,wkdir=None):
    ...
    temp=temp + ' <a href="' + http + '/figure4.jpg" target="_blank">Figure 4</a><br/>'
    temp=temp + ' <img src="' + http + '/figure4.jpg" alt="Figure 4"><br>'
    #temp=temp + ' <a href="' + http + '/figure4.jpg" target="_blank">' + http + '/figure4.jpg</a><br/>'
    temp=temp + ' <a href="' + http + '/figure5.jpg" target="_blank">Figure 5</a><br/>'
    temp=temp + ' <img src="' + http + '/figure5.jpg" alt="Figure 5"><br>'
    #temp=temp + ' <a href="' + http + '/figure5.jpg" target="_blank">' + http + '/figure5.jpg</a><br/>'
    temp=temp + ' <a href="' + http + '/figure7.jpg" target="_blank">Figure 7</a><br/>'
    temp=temp + ' <img src="' + http + '/figure7.jpg" alt="Figure 7"><br>'
    #temp=temp + ' <a href="' + http + '/figure7.jpg" target="_blank">' + http + '/figure7.jpg</a><br/>'
    temp=temp + ' <a href="' + http + '/figure8.jpg" target="_blank">Figure 8</a><br/>'
    temp=temp + ' <img src="' + http + '/figure8.jpg" alt="Figure 8"><br>'
    #temp=temp + ' <a href="' + http + '/figure8.jpg" target="_blank">' + http + '/figure8.jpg</a><br/>'
    temp=temp + ' <a href="' + http + '/figure9.jpg" target="_blank">Figure 9</a><br/>'
    temp=temp + ' <img src="' + http + '/figure9.jpg" alt="Figure 9"><br>'
